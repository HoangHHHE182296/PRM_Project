# management_openapi.api.ProductApi
...
[**apiProductsGetDeletedProductsGet**](ProductApi.md#apiproductsgetdeletedproductsget) | **GET** /api/products/get-deleted-products | 
...
[**apiProductsPermanentDeleteProductIdDelete**](ProductApi.md#apiproductspermanentdeleteproductiddelete) | **DELETE** /api/products/permanent-delete-product/{id} | 
[**apiProductsRestoreProductIdPut**](ProductApi.md#apiproductsrestoreproductidput) | **PUT** /api/products/restore-product/{id} | 
...
final api = ManagementOpenapi().getProductApi();
...
> ProductListResponsePagedResultApiSuccessResponse apiProductsGetDeletedProductsGet(type, categoryId, search, sortBy, sortDescending, pageNumber, pageSize)
...
try {
    final response = api.apiProductsGetDeletedProductsGet(type, categoryId, search, sortBy, sortDescending, pageNumber, pageSize);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ProductApi->apiProductsGetDeletedProductsGet: $e\n');
}
```
...
> BooleanApiSuccessResponse apiProductsPermanentDeleteProductIdDelete(id)
...
try {
    final response = api.apiProductsPermanentDeleteProductIdDelete(id);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ProductApi->apiProductsPermanentDeleteProductIdDelete: $e\n');
}
```
...
> BooleanApiSuccessResponse apiProductsRestoreProductIdPut(id)
...
try {
    final response = api.apiProductsRestoreProductIdPut(id);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ProductApi->apiProductsRestoreProductIdPut: $e\n');
}
```
