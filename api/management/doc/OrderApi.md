# management_openapi.api.OrderApi
...
final api = ManagementOpenapi().getOrderApi();
...
> BooleanApiSuccessResponse apiOrdersIdStatusPut(id, updateOrderStatusCommand)
...
final api = ManagementOpenapi().getOrderApi();
final String id = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 
final UpdateOrderStatusCommand updateOrderStatusCommand = ; // UpdateOrderStatusCommand | 

try {
    final response = api.apiOrdersIdStatusPut(id, updateOrderStatusCommand);
    print(response);
} on DioException catch (e) {
...
------------- | ------------- | ------------- | -------------
 **id** | **String**|  | 
 **updateOrderStatusCommand** | [**UpdateOrderStatusCommand**](UpdateOrderStatusCommand.md)|  | [optional] 
