...
void main() {
  final instance = ManagementOpenapi().getProductApi();
  ...
  group(ProductApi, () {
    ...
    //Future<ProductListResponsePagedResultApiSuccessResponse> apiProductsGetDeletedProductsGet({ ProductType type, String categoryId, String search, String sortBy, bool sortDescending, int pageNumber, int pageSize }) async
    test('test apiProductsGetDeletedProductsGet', () async {
      // TODO
    });
    ...
    //Future<BooleanApiSuccessResponse> apiProductsPermanentDeleteProductIdDelete(String id) async
    test('test apiProductsPermanentDeleteProductIdDelete', () async {
      // TODO
    });

    //Future<BooleanApiSuccessResponse> apiProductsRestoreProductIdPut(String id) async
    test('test apiProductsRestoreProductIdPut', () async {
      // TODO
    });
