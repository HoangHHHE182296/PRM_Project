...
class FeedbackApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [FeedbackResponsePagedResultApiSuccessResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FeedbackResponsePagedResultApiSuccessResponse>> apiFeedbacksAdminGetListGet({ 
    String? userId,
    String? productId,
    DateTime? startDate,
    DateTime? endDate,
    ...
    final _path = r'/api/feedbacks/admin/get-list';
    ...
    FeedbackResponsePagedResultApiSuccessResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FeedbackResponsePagedResultApiSuccessResponse),
      ) as FeedbackResponsePagedResultApiSuccessResponse;
    ...
    return Response<FeedbackResponsePagedResultApiSuccessResponse>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BooleanApiSuccessResponse>> apiFeedbacksAdminIdApprovePut({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/feedbacks/admin/{id}/approve'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BooleanApiSuccessResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BooleanApiSuccessResponse>> apiFeedbacksAdminIdRejectPut({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/feedbacks/admin/{id}/reject'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BooleanApiSuccessResponse>> apiFeedbacksAdminIdReplyPut({ 
    ...
    final _path = r'/api/feedbacks/admin/{id}/reply'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
