...
class FeedbackStatus extends EnumClass {
  ...
  static const FeedbackStatus processing = _$processing;
  @BuiltValueEnumConst(wireName: r'Accepted')
  static const FeedbackStatus accepted = _$accepted;
  @BuiltValueEnumConst(wireName: r'Reject')
  static const FeedbackStatus reject = _$reject;

  static Serializer<FeedbackStatus> get serializer => _$feedbackStatusSerializer;
