...
class ConsultationApi {
  ...
  const ConsultationApi(this._dio, this._serializers);
  ...
  Future<Response<AiRecommendationResponseApiSuccessResponse>> apiConsultationChatPost({ 
    ...
    final _path = r'/api/consultation/chat';
    ...
    AiRecommendationResponseApiSuccessResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AiRecommendationResponseApiSuccessResponse),
      ) as AiRecommendationResponseApiSuccessResponse;
    ...
    return Response<AiRecommendationResponseApiSuccessResponse>(
      data: _responseData,
  ...
  Future<Response<GuidApiSuccessResponse>> apiConsultationStartPost({ 
    ...
    final _path = r'/api/consultation/start';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GuidApiSuccessResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GuidApiSuccessResponse),
      ) as GuidApiSuccessResponse;
    ...
    return Response<GuidApiSuccessResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
